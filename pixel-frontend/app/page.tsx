...
const FloatingTextDivider = () => (
  <motion.div
    initial={{ y: 0 }}
    animate={{ y: [0, -10, 0, 10, 0] }} // floating up & down
...
export default function Home() {
  // Refs for scroll-triggered headings
  const featuresRef = useRef(null);
  const servicesRef = useRef(null);

  // Triggers when heading enters viewport
...
<section id="features" className="py-24 px-6 md:px-12 lg:px-24 text-center">
  ...
  <div className="grid gap-12 md:grid-cols-3">
    {[
      ...
      <motion.div
        key={i}
        initial={{ opacity: 0, y: 100, scale: 0.95 }} // start lower
        animate={featuresInView ? { opacity: 1, y: 0, scale: 1 } : {}}
        transition={{
          type: "spring",
          stiffness: 120,   // bounce effect
          damping: 12,      // smooth landing
...
<section id="services" className="py-24 px-6 md:px-12 lg:px-24 text-center">
  ...
  <div className="grid gap-10 md:grid-cols-2 lg:grid-cols-3">
    {[
      ...
      <motion.div
        key={i}
        initial={{ opacity: 0, y: 100, scale: 0.95 }} // start below
        animate={servicesInView ? { opacity: 1, y: 0, scale: 1 } : {}}
        transition={{
          type: "spring",
          stiffness: 120,
